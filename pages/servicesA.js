            ...
            <div className='ui center aligned basic very padded segment'>
                <div className='ui center aligned basic very padded segment'>
                    ...
                    <div className='ui stackable relaxed grid container'>
                        <div className='ui row'> 
                            {props.dash.map((dashboard, key) => (
                                <div className='ui five wide column'>
                                    <DashboardHolder id={dashboard.id} title={dashboard.title} image={dashboard.image} description={dashboard.description} />
                                </div>
                            ))}
                        </div>
                    </div>
