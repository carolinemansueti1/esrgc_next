export default () => {
    return [
        ...
        
        {
          ...
          related_links_exist: "1",
          related_links: ["Chesapeake Bay Critical Area"],
          related_links_urls: [
            "http://dnr.maryland.gov/criticalarea/Pages/map_update.aspx"
          ]
        },
        {
          id: 5,
          title: "Legislative District Land Use Mapping",
          image: "pier_dock.png",
        ...
        },
        {
          ...
          related_links_exists: "1",
          related_links: ["Maryland FirstNet Broadband Initiative"],
          related_links_urls: ["https://firstnet.maryland.gov/Pages/default.aspx"]
        }
      ]
